...
cd ../cuda/
nvcc -c -o roi_align_forward_cuda_kernel.cu.o roi_align_forward_cuda_kernel.cu -x cu -Xcompiler -fPIC -arch=sm_30
nvcc -c -o roi_align_backward_cuda_kernel.cu.o roi_align_backward_cuda_kernel.cu -x cu -Xcompiler -fPIC -arch=sm_30
cd ../../
